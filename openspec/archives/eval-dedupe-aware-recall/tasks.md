...
- [x] R.3 If same-title duplicates survive deterministic dedupe, file the
  surviving patterns in ../../../docs/product/BACKLOG.md as a Step 3 two-tier-dedupe refinement
  candidate (do NOT implement it here)
- [x] R.4 Mark BACKLOG E2 fixed; update ../../../docs/product/STATUS.md in the same commit
