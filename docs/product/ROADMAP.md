...
| 13 | UI: feed + conversations web UI (Next.js) — daily briefing cards (one exercise, one resurfaced idea, fading list), per-card "Talk about this", master composer, conversation view with back-to-feed; builds on Steps 5 & 7, independent of proposed Steps 8–12 | 📋 Intent approved 2026-09-21 — umbrella at `../../openspec/archives/step-13-ui-feed-conversations/`; 13a ✅ done (feed API, 2026-09-22), 13b ✅ done (feed screen, 2026-09-23); 13c/13d queued in `../../openspec/changes/step-13c-conversation/`, `../../openspec/changes/step-13d-serve-command/` | `../../intent/ui-feed-and-conversations.md` → `../../openspec/changes/step-13-ui-feed-conversations/` (+ `step-13c-conversation/`, `step-13d-serve-command/`) |
